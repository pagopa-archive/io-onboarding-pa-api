...
>NOTE: the *docker-compose.yaml* file sets some environment variables that could be used to adapt the application features to specific needs. Variable values can be modified editing the *.env* file in this repository. More info about variables can be found in the dedicated paragraph, below in the readme.
